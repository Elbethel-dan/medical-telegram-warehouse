...
Examples:
    ...
    target_channels = [
        ...
        '@tikvahpharma',    # Tikvah Pharmaceuticals - Medical supplies & drugs
        '@tenamereja',    # Medical Information Center - Health tips & info
        '@rayapharmaceuticals',  # Raya Pharmaceuticals Import & Wholesale - 
        '@Pharmaimportt', # Pharma-Med Ethiopia - Drugs
        '@pharmaworldethiopia', # Pharma World - Drugs
        '@cafimadEt' # Cafimad MedFinder - Drugs or medical equipment 
